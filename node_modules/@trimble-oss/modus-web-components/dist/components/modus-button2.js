...
const ModusButton = /*@__PURE__*/ proxyCustomElement(class ModusButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return modusButtonCss; }
}, [1, "modus-button", {
...
function defineCustomElement() {
  ...
  const components = ["modus-button"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusButton);
      }
      break;
  } });
}

export { ModusButton as M, defineCustomElement as d };
