...
const ModusDropdown = /*@__PURE__*/ proxyCustomElement(class ModusDropdown extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h("div", { "aria-label": this.ariaLabel, class: "dropdown", role: "listbox", onClick: (event) => this.handleDropdownClick(event) }, h("slot", { name: "dropdownToggle" }), h("div", { class: listContainerClass, style: {
  ...
  components.forEach(tagName => { switch (tagName) {
    case "modus-dropdown":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusDropdown);
      }
      break;
  } });
}

export { ModusDropdown as M, defineCustomElement as d };
