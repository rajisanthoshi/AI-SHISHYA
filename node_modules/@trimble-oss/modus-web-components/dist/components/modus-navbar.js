...
import { I as IconMap, c as IconMenu, d as IconNotifications, e as IconApps } from './IconMap.js';
...
import { d as defineCustomElement$a } from './modus-dropdown2.js';
...
const ModusNavbarProductLogo = ({ logos, onClick }) => {
  ...
  return (h("div", { onClick: onClick, class: "product-logo" },
...
const ModusNavbarButtonList = ({ buttons, reverse, onClick, openButtonMenuId }) => {
  ...
  return navbarButtons.map((button, index) => {
    var _a;
    return (h("div", { onClick: (event) => onClick(event, button) },
      h("modus-dropdown", { "toggle-element-id": 'navbar-button-' + index },
        h("div", { class: "navbar-button", id: 'navbar-button-' + index, slot: "dropdownToggle" },
          h("span", { class: "navbar-button-icon", tabIndex: 0 },
            h("modus-tooltip", { text: (_a = button.tooltip) === null || _a === void 0 ? void 0 : _a.text, position: "bottom" },
              h("div", { class: "icon-button" },
                h(IconMap, { icon: button.icon, size: "24", pressed: openButtonMenuId === button.id }))))),
...
const ModusNavbar$1 = /*@__PURE__*/ proxyCustomElement(class ModusNavbar extends HTMLElement {
  ...
  static get style() { return modusNavbarCss; }
}, [1, "modus-navbar", {
    "apps": [16],
    "buttons": [1040],
...
function defineCustomElement$1() {
  ...
  const components = ["modus-navbar", "modus-dropdown", "modus-navbar-apps-menu", "modus-navbar-button-menu", "modus-navbar-main-menu", "modus-navbar-notifications-menu", "modus-navbar-profile-menu", "modus-navbar-search-overlay", "modus-text-input", "modus-tooltip"];
