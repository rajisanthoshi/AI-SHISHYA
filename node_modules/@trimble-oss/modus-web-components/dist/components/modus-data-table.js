...
import { a as IconSortAZ, b as IconSortZA, I as IconMap } from './IconMap.js';
...
const ModusDataTableRowActionDropdown = (props) => {
  return (h("modus-dropdown", { "toggle-element-id": `dropdownToggle-${props.rowId}`, "animate-list": props.animateDropdown, customPlacement: { left: -194 } },
    h("div", { class: "row-action", id: `dropdownToggle-${props.rowId}`, slot: "dropdownToggle" },
      h(IconMap, { icon: "vertical-ellipsis", size: "24" })),
      ...
      h("div", { class: "list-container" },
        h("div", { class: "items-container" }, props.actions.map((action) => (h("div", { class: "action-item", onClick: () => props.onRowActionClick(action._id, props.rowId) },
          h("div", { class: "action-item-content" },
            action.display.icon && h(IconMap, { icon: action.display.icon, size: '16' }),
...
const ModusDataTable$1 = /*@__PURE__*/ proxyCustomElement(class ModusDataTable extends HTMLElement {
  ...
  render() {
    ...
    `;
    return (h("table", { class: className }, h("colgroup", null, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && h("col", { style: { width: '34px' } }), (_a = this.columns) === null || _a === void 0 ? void 0 :
      _a.map((column) => h("col", { style: { width: column.width } })), !!this.rowActions.length && h("col", { style: { width: '34px' } })), h("thead", null, h("tr", null, this.selectionOptions.canSelect && this.selectionOptions.checkboxSelection && (h("th", null, h("div", { class: "column-header align-center" }, h("modus-checkbox", { checked: this.allSelected, onCheckboxClick: (e) => this.handleHeaderCheckboxClick(e.detail) })))), (_b = this.columns) === null || _b === void 0 ? void 0 :
      _b.map((column) => (h(ModusDataTableHeader, { column: column, onColumnHeaderClick: (id) => this.handleColumnHeaderClick(id), sortOptions: this.sortOptions, sortState: this.sortState }))), !!this.rowActions.length && h("th", null))), h("tbody", null, (_c = this.data) === null || _c === void 0 ? void 0 : _c.map((row) => {
      var _a;
  ...
  static get style() { return modusDataTableCss; }
}, [1, "modus-data-table", {
    "columns": [1040],
    "data": [1040],
    "displayOptions": [16],
