...
const ModusAccordionItem$1 = /*@__PURE__*/ proxyCustomElement(class ModusAccordionItem extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h("div", { "aria-disabled": this.disabled ? 'true' : undefined, "aria-expanded": this.expanded ? 'true' : undefined, class: "accordion-item" }, h("div", { class: headerClass, onClick: () => this.handleHeaderClick(), onKeyDown: (event) => this.handleKeydown(event), tabIndex: 0 }, h("span", { class: "title" }, this.headerText), h("div", { class: `chevron-container ${this.expanded ? 'reverse' : ''} `, ref: (el) => (this.chevronContainerRef = el) }, h(IconChevronDownThick, { size: "24" }))), h("div", { class: bodyClass, ref: (el) => (this.accordionBodyRef = el) }, h("div", { class: "body-content" }, h("slot", null)))));
  }
  static get style() { return modusAccordionItemCss; }
