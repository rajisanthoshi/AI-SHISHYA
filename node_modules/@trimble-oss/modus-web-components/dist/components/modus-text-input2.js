...
import { I as IconSearch, a as IconVisibility, b as IconVisibilityOff } from './icon-visibility-off.js';
...
const ModusTextInput = /*@__PURE__*/ proxyCustomElement(class ModusTextInput extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return modusTextInputCss; }
}, [1, "modus-text-input", {
    ...
    "includePasswordTextToggle": [4, "include-password-text-toggle"],
    "inputmode": [1],
    "label": [1],
...
function defineCustomElement() {
  ...
  const components = ["modus-text-input"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-text-input":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusTextInput);
      }
      break;
  } });
}

export { ModusTextInput as M, defineCustomElement as d };
