...
const ModusTimePicker$1 = /*@__PURE__*/ proxyCustomElement(class ModusTimePicker extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return modusTimePickerCss; }
}, [1, "modus-time-picker", {
    "ampm": [4],
    "allowedCharsRegex": [1, "allowed-chars-regex"],
    "ariaLabel": [1, "aria-label"],
    "autoFormat": [4, "auto-format"],
...
function defineCustomElement$1() {
  ...
  const components = ["modus-time-picker"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-time-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusTimePicker$1);
      }
      break;
  } });
}

const ModusTimePicker = ModusTimePicker$1;
const defineCustomElement = defineCustomElement$1;

export { ModusTimePicker, defineCustomElement };
