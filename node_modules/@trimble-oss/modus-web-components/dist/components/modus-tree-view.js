...
const ModusTreeView$1 = /*@__PURE__*/ proxyCustomElement(class ModusTreeView extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return modusTreeViewCss; }
}, [1, "modus-tree-view", {
    "checkboxSelection": [4, "checkbox-selection"],
    "checkedItems": [1040],
    "disableTabbing": [1028, "disable-tabbing"],
    "expandedItems": [1040],
    "multiCheckboxSelection": [4, "multi-checkbox-selection"],
    "multiSelection": [4, "multi-selection"],
    "selectedItems": [1040],
    "size": [1],
    "itemDragState": [32]
  }, [[4, "click", "handleDocumentClick"], [0, "itemAdded", "handleItemAdded"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["modus-tree-view"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-tree-view":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusTreeView$1);
      }
      break;
  } });
}

const ModusTreeView = ModusTreeView$1;
const defineCustomElement = defineCustomElement$1;

export { ModusTreeView, defineCustomElement };
