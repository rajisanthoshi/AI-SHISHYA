...
import { C as COLUMN_DEF_DATATYPE_LINK, a as COLUMN_DEF_DATATYPE_KEY, b as COLUMN_DEF_DATATYPE_INTEGER, K as KEYBOARD_ENTER, c as KEYBOARD_SPACE, d as KEYBOARD_TAB, e as KEYBOARD_ESCAPE, f as KEYBOARD_LEFT, g as KEYBOARD_RIGHT, S as SORTED_ASCENDING, h as SORTED_DESCENDING, i as SORT_ASCENDING, j as SORT_DESCENDING, P as PAGINATION_PAGEVIEW_TEXT, k as PAGINATION_SUMMARY_TEXT, l as COLUMN_DEF_ROW_SELECTION_ID, m as COLUMN_DEF_ROW_SELECTION_CSS, n as COLUMN_DEF_SHOWTOTAL, o as PAGINATION_DEFAULT_SIZES, p as defineCustomElement$6 } from './modus-table-columns-visibility2.js';
import { I as IconChevronDownThick } from './icon-chevron-down-thick.js';
import { f as IconChevronUpThick, a as IconSortAZ, b as IconSortZA } from './IconMap.js';
import { d as defineCustomElement$a } from './modus-button2.js';
import { d as defineCustomElement$9 } from './modus-checkbox2.js';
import { d as defineCustomElement$8 } from './modus-pagination2.js';
import { d as defineCustomElement$7 } from './modus-select2.js';
import { d as defineCustomElement$5 } from './modus-table-dropdown-menu2.js';
import { d as defineCustomElement$4 } from './modus-table-filler-column2.js';
import { d as defineCustomElement$3 } from './modus-table-toolbar2.js';
...
const ModusTableCellLinkElement = ({ link, onLinkClick }) => {
  return (h("div", { class: "cell-link wrap-text", onClick: () => onLinkClick(link) }, link.display));
};
...
const ModusTableCellExpandIcons = ({ cellIndex, row }) => {
  return (h("span", { class: "expand", style: { paddingLeft: `${cellIndex === 0 ? row.depth * 2 : 0}rem` }, onClick: row.getToggleExpandedHandler() }, cellIndex === 0 && row.getCanExpand() ? (row.getIsExpanded() ? (h(IconChevronUpThick, { size: '24' })) : (h(IconChevronDownThick, { size: '24' }))) : ('')));
};
...
const ModusTableColumnResizingHandler = ({ table, header, onMouseEnter, onMouseLeave, }) => {
  return (h("div", { tabindex: 0, onMouseDown: header.getResizeHandler(), onTouchStart: header.getResizeHandler(), onKeyDown: throttle(table, header.column), onMouseEnter: () => onMouseEnter(), onMouseLeave: () => onMouseLeave(), class: "resize-handle" }));
};
...
const ModusTableHeader = ({ table, header, isNestedParentHeader, showSortIconOnHover, columnReorder, isColumnResizing, frozenColumns, onDragStart, onMouseEnterResize, onMouseLeaveResize, }) => {
  ...
  return (h("th", { tabindex: `${!isColumnResizing && columnReorder ? '0' : ''}`, key: id, colSpan: colSpan, 
    ...
    h("div", { class: column.getCanSort() && 'can-sort' },
      h("span", null, column.columnDef.header),
      column.getCanSort() && (h(ModusTableHeaderSort, { column: column, showSortIconOnHover: showSortIconOnHover, isColumnResizing: isColumnResizing })))),
...
const IconArrowDown = (props) => {
  var _a, _b, _c;
  return (h("svg", { class: "icon-arrow-down", xmlns: "http://www.w3.org/2000/svg", fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, onClick: props.onClick, "data-test-id": "iconArrowDown", viewBox: "0 0 24 24" },
...
const IconArrowUp = (props) => {
  var _a, _b, _c;
  return (h("svg", { class: "icon-arrow-up", xmlns: "http://www.w3.org/2000/svg", fill: (_a = props.color) !== null && _a !== void 0 ? _a : 'currentColor', height: (_b = props.size) !== null && _b !== void 0 ? _b : 16, width: (_c = props.size) !== null && _c !== void 0 ? _c : 16, onClick: props.onClick, "data-test-id": "iconArrowUp", viewBox: "0 0 24 24" },
...
const ModusTablePagination = ({ table, totalCount, pageSizeList, }) => {
  ...
  return (h("div", { class: "pagination-container" },
    h("div", { class: "items-per-page" },
      ...
      h("modus-select", { "options-display-prop": "display", options: optionsList, onValueChange: handleChange, value: selectedPageSize })),
    h("div", { class: "pagination-and-count" },
      h("div", { class: "total-count" },
        ...
        h("span", null, "of"),
        h("span", null, options.paginateExpandedRows ? getExpandedRowModel().rows.length : totalCount),
        ' '),
      h("modus-pagination", { "active-page": 1, "max-page": getPageCount(), "min-page": 1, onPageChange: (event) => setPageIndex(event.detail - 1) }))));
};
...
const ModusTableSummaryRow = ({ footerGroups, tableData, frozenColumns, rowSelection, }) => {
  return (h("tfoot", null, footerGroups.map((group) => (h("tr", { class: "summary-row" },
    rowSelection && (h("td", { id: COLUMN_DEF_ROW_SELECTION_ID, key: COLUMN_DEF_ROW_SELECTION_ID, class: COLUMN_DEF_ROW_SELECTION_CSS })),
...
const ModusTable$1 = /*@__PURE__*/ proxyCustomElement(class ModusTable extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return modusTableCss; }
}, [1, "modus-table", {
    "columns": [1040],
    "data": [1040],
    "hover": [4],
    "columnResize": [4, "column-resize"],
    "fullWidth": [4, "full-width"],
    "sort": [4],
    "showSortIconOnHover": [4, "show-sort-icon-on-hover"],
    "pagination": [4],
    "pageSizeList": [16],
    ...
    "rowSelectionOptions": [16],
    "columnReorder": [4, "column-reorder"],
    "rowsExpandable": [4, "rows-expandable"],
    ...
    "getColumnData": [64],
    "toggleColumnVisibility": [64]
  }, [[4, "click", "documentClickHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["modus-table", "modus-button", "modus-checkbox", "modus-pagination", "modus-select", "modus-table-columns-visibility", "modus-table-dropdown-menu", "modus-table-filler-column", "modus-table-toolbar", "modus-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-table":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusTable$1);
      }
      break;
    case "modus-button":
      if (!customElements.get(tagName)) {
...
const ModusTable = ModusTable$1;
const defineCustomElement = defineCustomElement$1;

export { ModusTable, defineCustomElement };
