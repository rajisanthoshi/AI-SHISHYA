...
const ModusIcon$1 = /*@__PURE__*/ proxyCustomElement(class ModusIcon extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return h(IconMap, { icon: this.name, onClick: this.onClick, size: this.size, color: this.color });
  }
}, [1, "modus-icon", {
    "name": [1],
    "size": [1],
