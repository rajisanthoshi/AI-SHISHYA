...
const ModusModal$1 = /*@__PURE__*/ proxyCustomElement(class ModusModal extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return modusModalCss; }
}, [1, "modus-modal", {
    "ariaLabel": [1, "aria-label"],
    "headerText": [1, "header-text"],
    "primaryButtonAriaLabel": [1, "primary-button-aria-label"],
    "primaryButtonDisabled": [4, "primary-button-disabled"],
    "primaryButtonText": [1, "primary-button-text"],
    "secondaryButtonAriaLabel": [1, "secondary-button-aria-label"],
    "secondaryButtonDisabled": [4, "secondary-button-disabled"],
    ...
    "close": [64],
    "open": [64]
  }, [[4, "keydown", "documentKeyHandler"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["modus-modal", "modus-button"];
  components.forEach(tagName => { switch (tagName) {
    case "modus-modal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ModusModal$1);
      }
      break;
    case "modus-button":
      if (!customElements.get(tagName)) {
...
const ModusModal = ModusModal$1;
const defineCustomElement = defineCustomElement$1;

export { ModusModal, defineCustomElement };
