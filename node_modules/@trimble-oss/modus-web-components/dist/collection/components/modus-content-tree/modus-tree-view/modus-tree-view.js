...
export class ModusTreeView {
  ...
  render() {
    return (h(Host, null, h("ul", { role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, h("slot", { onSlotchange: () => this.handleTreeSlotChange() })), h(ModusContentTreeDragItem, { draggingState: this.itemDragState })));
  }
  static get is() { return "modus-tree-view"; }
  ...
  static get properties() {
    return {
      "checkboxSelection": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Enables checkbox selection on each tree item"
        },
      ...
      "checkedItems": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Set checked tree items"
        },
        "defaultValue": "[]"
      },
      "disableTabbing": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Disable usage of `tab` key to focus elements inside a tree view. Use `Arrow Up/Down` for focussing a tree item and `Shift + Arrow Right` for focussing a checkbox inside the item."
        },
        "attribute": "disable-tabbing",
        "reflect": false
      },
      "expandedItems": {
        "type": "unknown",
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Set expanded tree items"
        },
        "defaultValue": "[]"
      },
      "multiCheckboxSelection": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Enables multiple checkbox selection"
        },
        "attribute": "multi-checkbox-selection",
        "reflect": false
      },
      "multiSelection": {
        "type": "boolean",
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Enables multiple tree items selection"
        },
      ...
      "selectedItems": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) Set selected tree items"
        },
        "defaultValue": "[]"
      },
      "size": {
        ...
        "docs": {
          "tags": [],
          "text": "(optional) The default size of all tree items"
        },
        "attribute": "size",
        "reflect": false,
  ...
  static get watchers() {
    return [{
        ...
        "propName": "checkboxSelection",
        "methodName": "handleOptionsProps"
      }, {
        "propName": "disableTabbing",
        "methodName": "handleOptionsProps"
      }, {
        "propName": "multiCheckboxSelection",
        "methodName": "handleOptionsProps"
      }, {
