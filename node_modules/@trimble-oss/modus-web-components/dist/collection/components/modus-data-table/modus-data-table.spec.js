...
describe('modus-data-table', () => {
  ...
  it('should convert column prop as string array to TColumn array', async () => {
    const cols = ModusDataTableUtilities.convertToTColumns(['name', 'age']);
    expect(cols).toEqual([
  ...
  it('should convert column prop as TColumn array to TColumn array', async () => {
    const cols = ModusDataTableUtilities.convertToTColumns([{ display: 'name' }, { display: 'age' }]);
    expect(cols).toEqual([
      { align: 'left', display: 'name', id: 'name', readonly: false, width: '' },
      { align: 'left', display: 'age', id: 'age', readonly: false, width: '' },
    ]);
  ...
  it('should convert column prop as TColumn (with ids) array to TColumn array', async () => {
    const cols = ModusDataTableUtilities.convertToTColumns([
  ...
  it('should sort data links', async () => {
    ...
    const ascLinks = ModusDataTableUtilities.sortData(rows, 'link', 'asc');
    const descLinks = ModusDataTableUtilities.sortData(rows, 'link', 'desc');
  ...
  it('should sort data badges', async () => {
    ...
    const ascBadges = ModusDataTableUtilities.sortData(rows, 'badge', 'asc');
    const descBadges = ModusDataTableUtilities.sortData(rows, 'badge', 'desc');
