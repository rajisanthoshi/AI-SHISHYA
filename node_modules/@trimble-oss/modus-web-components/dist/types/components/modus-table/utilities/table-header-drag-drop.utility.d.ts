...
export declare class TableHeaderDragDrop {
  ...
  setValues(columnOrder: string[], columnReorder: boolean, columnResizeEnabled: boolean, tableHeaderRowRef: HTMLTableRowElement, table: Table<unknown>, itemDragState: ColumnDragState, frozenColumns: string[]): void;
  /**
