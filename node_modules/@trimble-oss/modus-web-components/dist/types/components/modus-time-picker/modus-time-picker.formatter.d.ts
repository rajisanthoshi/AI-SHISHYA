export default class TimeInputFormatter {
  private readonly hasAmPm;
  constructor(hasAmPm: boolean);
  /** Format time input while typing */
  autoFormatTimeInput(val: string, autoFormat: boolean): string;
  ...
  setTimeOnDate(date: Date, val: string): Date | null;
  /** Validate key pressed */
  keyIsValidTimeCharacter(key: string, allowedKeysRegexInput?: RegExp | string): boolean;
  ...
  private getAutoFormatString;
  private processTimeRegex;
  private pad;
}
