...
const ModusToast = class {
  constructor(hostRef) {
    ...
    this.iconByType = new Map([
      ['danger', index.h(iconInfo.IconWarning, { color: '#C81922', size: '18' })],
      ...
      ['success', index.h(iconInfo.IconCheckCircle, { color: '#5E9331', size: '18' })],
      ['tertiary', index.h(iconInfo.IconInfo, { size: '18' })],
      ['warning', index.h(iconInfo.IconError, { color: '#FFBE00', size: '18' })],
    ]);
  ...
  render() {
    ...
    return (index.h("div", { "aria-label": this.ariaLabel, class: className, role: "status" }, this.showIcon && index.h("div", { class: "icon" }, icon), index.h("span", { class: 'text' }, index.h("slot", null)), index.h("span", { class: 'close' }, this.dismissible && index.h(iconClose.IconClose, { size: '18', onClick: () => this.dismissClick.emit() }))));
  }
};
