...
const ModusTextInput = class {
  ...
  render() {
    ...
    return (index.h("div", { class: buildContainerClassNames() }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null, index.h("div", { class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}`, onClick: () => this.textInput.focus() }, this.includeSearchIcon ? index.h(iconSearch.IconSearch, { size: "16" }) : null, index.h("input", { "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel, "aria-required": (_b = this.required) === null || _b === void 0 ? void 0 : _b.toString(), class: buildTextInputClassNames(), disabled: this.disabled, inputmode: this.inputmode, maxlength: this.maxLength, minlength: this.minLength, onInput: (event) => this.handleOnInput(event), placeholder: this.placeholder, readonly: this.readOnly, ref: (el) => (this.textInput = el), tabIndex: 0, type: this.type, value: this.value, autofocus: this.autoFocusInput }), showPasswordToggle && (index.h("div", { class: "icons toggle-password", role: "button", "aria-label": "Show password as plain text. Warning: this will display your password on the screen.", ref: (el) => (this.buttonTogglePassword = el), onClick: () => this.handleTogglePassword() }, index.h(iconVisibilityOff.IconVisibility, { size: "16" }), index.h(iconVisibilityOff.IconVisibilityOff, { size: "16" }))), showClearIcon && (index.h("span", { class: "icons clear", role: "button", "aria-label": "Clear entry" }, index.h(iconClose.IconClose, { onClick: () => this.handleClear(), size: "16" })))), this.errorText ? (index.h("label", { class: "sub-text error" }, this.errorText)) : this.validText ? (index.h("label", { class: "sub-text valid" }, this.validText)) : this.helperText ? (index.h("label", { class: "sub-text helper" }, this.helperText)) : null));
  }
...
exports.modus_text_input = ModusTextInput;
