...
const ModusTimePicker = class {
  constructor(hostRef) {
    ...
    this.timeInputBlur = index.createEvent(this, "timeInputBlur", 7);
  ...
  renderSubText() {
    return this.errorText ? (index.h("label", { class: "sub-text error" }, this.errorText)) : this.validText ? (index.h("label", { class: "sub-text valid" }, this.validText)) : this.helperText ? (index.h("label", { class: "sub-text helper" }, this.helperText)) : null;
  }
  render() {
    return (index.h("div", { class: { 'modus-time-picker': true, disabled: this.disabled } }, index.h("div", { class: "time-input-wrapper" }, this.label || this.required ? (index.h("div", { class: 'label-container' }, this.label ? index.h("label", { htmlFor: "time-input" }, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null, index.h("div", { class: `input-container ${this.errorText ? 'error' : this.validText ? 'valid' : ''} ${this.classBySize.get(this.size)}` }, this.renderTimeInput()), this.renderSubText()), index.h("div", { class: "time-zone-wrapper" }, index.h("slot", { name: "timeZone" }))));
  }
...
exports.modus_time_picker = ModusTimePicker;
