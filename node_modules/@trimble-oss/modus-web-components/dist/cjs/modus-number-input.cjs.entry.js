...
const ModusNumberInput = class {
  ...
  render() {
    ...
    return (index.h("div", { class: buildContainerClassNames() }, this.label || this.required ? (index.h("div", { class: "label-container" }, this.label ? index.h("label", null, this.label) : null, this.required ? index.h("span", { class: "required" }, "*") : null)) : null, index.h("div", { class: buildInputContainerClassNames() }, index.h("input", { "aria-label": this.ariaLabel, "aria-invalid": !!this.errorText, "aria-required": (_a = this.required) === null || _a === void 0 ? void 0 : _a.toString(), "aria-valuemax": this.maxValue, "aria-valuemin": this.minValue, "aria-valuenow": this.value, class: textAlignClassName, disabled: this.disabled, max: this.maxValue, min: this.minValue, onInput: () => this.handleOnInput(), placeholder: this.placeholder, readonly: this.readOnly, ref: (el) => (this.numberInput = el), step: this.step, tabIndex: 0, type: "number", value: this.value })), this.errorText ? (index.h("label", { class: "sub-text error" }, this.errorText)) : this.validText ? (index.h("label", { class: "sub-text valid" }, this.validText)) : this.helperText ? (index.h("label", { class: "sub-text helper" }, this.helperText)) : null));
  }
...
exports.modus_number_input = ModusNumberInput;
