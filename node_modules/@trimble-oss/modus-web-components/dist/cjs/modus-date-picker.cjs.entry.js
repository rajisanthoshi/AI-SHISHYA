...
const modusDateInput_formatter = require('./modus-date-input.formatter-5af51159.js');
...
class ModusDatePickerState {
  ...
  refresh() {
    ...
    const dateISORegex = new RegExp(modusDateInput_formatter.ISO_DATE_FORMAT);
...
const ModusDatePicker = class {
  ...
  renderCalendarBody() {
    ...
    return (index.h("div", { class: "calendar-body" }, index.h("div", { class: "calendar-days-week grid" }, this._calendar.getDaysOfWeek(this._locale).map((d) => {
      return index.h("div", { class: "grid-item" }, d);
    })), index.h("div", { class: "calendar-month-container" }, index.h("div", { class: {
      ...
      }), this._calendar.dates.map((date, index$1) => {
      if (!date) {
        return null;
      }
      ...
      const onBlurEvent = index$1 === this._calendar.dates.length - 1
        ? {
          onBlur: () => {
            this.toggleCalendar(false);
          },
        ...
        : {};
      return (index.h("button", Object.assign({ class: {
  ...
  renderCalendarHeader() {
    var _a, _b;
    return (index.h("div", { class: "calendar-header" }, index.h("button", { "aria-label": "Previous Month", onClick: () => this.addMonthOffset(-1) }, index.h(IconMap.IconMap, { icon: "chevron-left-thick" })), index.h("div", { class: "title" }, index.h("span", { tabIndex: 0, class: "calendar-title", "aria-label": "ModusCalendar title", role: "title" }, `${(_a = this._calendar) === null || _a === void 0 ? void 0 : _a.month} ${(_b = this._calendar) === null || _b === void 0 ? void 0 : _b.year}`), index.h("div", { class: "year-icons" }, index.h("button", { tabIndex: 0, "aria-label": "Next Year", onClick: () => this.addYearOffset(1), class: "year-up" }, index.h(IconMap.IconMap, { icon: "caret-up", size: "16" })), index.h("button", { tabIndex: 0, "aria-label": "Previous Year", onClick: () => this.addYearOffset(-1), class: "year-down" }, index.h(IconMap.IconMap, { size: "16", icon: "caret-down" })))), index.h("button", { tabIndex: 0, "aria-label": "Next Month", onClick: () => this.addMonthOffset(1) }, index.h(IconMap.IconMap, { icon: "chevron-right-thick" }))));
  }
  render() {
    return (index.h("div", { class: "modus-date-picker" }, this.label ? index.h("div", { class: 'label-container' }, this.label ? index.h("label", null, this.label) : null) : null, index.h("div", { class: "date-inputs" }, index.h("slot", { onSlotchange: () => this.handleSlotChange() })), index.h("div", { style: { display: 'inline-flex' } }, this._showCalendar && (index.h("nav", { class: "calendar-container", "aria-label": "Pick a Date" }, this.renderCalendarHeader(), this.renderCalendarBody())))));
  }
  get element() { return index.getElement(this); }
};
ModusDatePicker.style = modusDatePickerCss;

exports.modus_date_picker = ModusDatePicker;
