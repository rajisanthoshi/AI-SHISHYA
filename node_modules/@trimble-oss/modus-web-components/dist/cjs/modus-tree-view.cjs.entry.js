...
const ModusContentTreeDragItem = ({ draggingState, size, }) => {
  ...
  return index.h("div", { style: Object.assign({}, dragContainerStyle), ref: (el) => el && el.appendChild(dragContent), class: className });
};
...
const ModusTreeView = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ul", { role: "tree", tabindex: this.disableTabbing ? 0 : null, onKeyDown: (e) => this.handleKeyDown(e) }, index.h("slot", { onSlotchange: () => this.handleTreeSlotChange() })), index.h(ModusContentTreeDragItem, { draggingState: this.itemDragState })));
  }
...
ModusTreeView.style = modusTreeViewCss;

exports.modus_tree_view = ModusTreeView;
