...
const ModusAutocomplete = class {
  ...
  render() {
    ...
    return (index.h("div", { "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": !!this.errorText, "aria-label": this.ariaLabel, "aria-readonly": this.readOnly, "aria-required": this.required, class: classes, onFocusin: () => (this.hasFocus = true) }, this.TextInput(), index.h("div", { class: "options-container", style: { maxHeight: this.dropdownMaxHeight, zIndex: this.dropdownZIndex, overflowY: 'auto' } }, index.h("ul", null, this.displayOptions() &&
      ((_a = this.visibleOptions) === null || _a === void 0 ? void 0 : _a.map((option) => {
        return (index.h("li", { class: "text-option", onClick: () => this.handleOptionClick(option) }, option.value));
      })), this.displayOptions() &&
      ((_b = this.visibleCustomOptions) === null || _b === void 0 ? void 0 : _b.map((option) => (index.h("li", { class: "custom-option", onClick: () => this.handleCustomOptionClick(option), innerHTML: option.outerHTML }))))), this.displayNoResults() && index.h(NoResultsFound, { text: this.noResultsFoundText, subtext: this.noResultsFoundSubtext })), this.CustomOptionsSlot()));
  }
...
const NoResultsFound = (props) => (index.h("div", { class: "no-results" }, index.h("div", { style: { display: 'flex' } }, index.h(iconSearch.IconSearch, { size: "28px" }), index.h("div", { class: "message" }, props.text)), index.h("div", { class: "subtext" }, props.subtext)));
ModusAutocomplete.style = modusAutocompleteCss;

exports.modus_autocomplete = ModusAutocomplete;
