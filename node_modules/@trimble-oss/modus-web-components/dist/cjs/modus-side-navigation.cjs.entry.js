...
const ModusSideNavigationTree = ({ data, itemSelected, tabIndex }) => {
  ...
  return data === null || data === void 0 ? void 0 : data.map(({ id, disabled, selected, label, menuIcon, children, onSideNavItemClicked, options }) => {
    ...
    return (index.h("modus-side-navigation-item", Object.assign({ id: id, disabled: disabled, selected: selected || itemSelected === id, label: label, menuIcon: menuIcon, onSideNavItemClicked: (e) => onSideNavItemClicked && onSideNavItemClicked(e) }, defaults, { tabIndex: tabIndex }, props)));
  });
};
...
const ModusSideNavigation = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.sideNavExpand = index.createEvent(this, "sideNavExpand", 7);
  ...
  render() {
    return (index.h("nav", { role: "navigation", class: `side-nav-panel${this.expanded ? ' expanded' : ''}`, style: { width: this.expanded ? this.maxWidth : null }, onKeyDown: (e) => this.handleKeyDown(e), "aria-label": "side navigation" }, this.data ? (index.h("div", { tabindex: -1, ref: (el) => this.handleLevelsContainerRef(el) }, this._navigationLevels.map((level, index$1) => (index.h("div", { class: `side-nav-level ${level.levelPosition}`, "aria-hidden": level.levelPosition !== 'center' ? 'true' : null }, index$1 !== 0 && (index.h("div", Object.assign({ class: "level-heading" }, (level.levelPosition === 'center'
      ? {
        tabindex: 0,
        ref: (el) => this.handleLevelHeadingRef(el),
      }
      : {})), index.h("p", null, index.h(iconChevronLeftThick.IconChevronLeftThick, { size: "10" }), index.h("a", { tabIndex: 0, onClick: (e) => this.handleBackClick(e), onKeyDown: (e) => this.handleBackClick(e) }, "Back")), index.h("h4", null, level.label))), index.h("div", null, index.h("ul", { class: "side-nav-menu", role: "tree" }, index.h(ModusSideNavigationTree, { data: level.children, itemSelected: this._itemSelected, tabIndex: level.levelPosition === 'center' ? undefined : -1 })))))))) : (index.h("div", { class: "side-nav-level center" }, index.h("ul", { class: "side-nav-menu", role: "tree" }, index.h("slot", null))))));
  }
...
ModusSideNavigation.style = modusSideNavigationCss;

exports.modus_side_navigation = ModusSideNavigation;
