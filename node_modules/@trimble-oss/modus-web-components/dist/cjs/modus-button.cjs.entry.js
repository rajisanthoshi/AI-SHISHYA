...
const ModusButton = class {
  ...
  renderIconWithText() {
    return (index.h(index.Fragment, null, this.leftIcon && (index.h("span", { class: "icon left-icon" }, index.h(IconMap.IconMap, { icon: this.leftIcon }))), index.h("span", { class: "label" }, index.h("slot", null)), this.rightIcon && !this.showCaret && (index.h("span", { class: "icon right-icon" }, index.h(IconMap.IconMap, { icon: this.rightIcon })))));
  }
  renderIconOnly() {
    return (index.h("span", { class: "icon" }, index.h(IconMap.IconMap, { icon: this.iconOnly })));
  }
  render() {
    ...
    return (index.h("button", { "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel, "aria-pressed": this.pressed ? 'true' : undefined, class: className, disabled: this.disabled, onClick: () => (!this.disabled ? this.buttonClick.emit() : null), onKeyDown: () => (this.pressed = true), onKeyUp: () => (this.pressed = false), onMouseDown: () => (this.pressed = true), onMouseUp: () => (this.pressed = false), role: "button", ref: (el) => (this.buttonRef = el) }, this.iconOnly ? this.renderIconOnly() : this.renderIconWithText(), this.showCaret && index.h(IconMap.IconMap, { size: "24", icon: "caret-down" })));
  }
  get el() { return index.getElement(this); }
};
ModusButton.style = modusButtonCss;

exports.modus_button = ModusButton;
