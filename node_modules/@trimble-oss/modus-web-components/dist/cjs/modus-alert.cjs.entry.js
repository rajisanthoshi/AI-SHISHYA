...
const ModusAlert = class {
  ...
  render() {
    ...
    const iconSize = '24';
    return (index.h("div", { "aria-label": this.ariaLabel, class: className, role: "alert", tabIndex: 0 }, this.type === 'error' ? index.h(iconInfo.IconError, { size: iconSize }) : null, this.infoTypes.includes(this.type) ? index.h(iconInfo.IconInfo, { size: iconSize }) : null, this.type === 'success' ? index.h(iconInfo.IconCheckCircle, { size: iconSize }) : null, this.type === 'warning' ? index.h(iconInfo.IconWarning, { size: iconSize }) : null, index.h("div", { class: "message" }, this.message, index.h("slot", null)), this.dismissible ? index.h(iconClose.IconClose, { size: "18", onClick: () => this.dismissClick.emit() }) : null));
  }
};
ModusAlert.style = modusAlertCss;

exports.modus_alert = ModusAlert;
