...
const ModusSlider = class {
  ...
  render() {
    ...
    return (index.h("div", { "aria-disabled": this.disabled ? 'true' : undefined, "aria-label": this.ariaLabel, "aria-valuemax": this.maxValue, "aria-valuemin": this.minValue, "aria-valuenow": this.value, class: className }, this.label && index.h("label", null, this.label), index.h("input", { class: "slider", disabled: this.disabled, max: this.maxValue, min: this.minValue, onChange: (event) => this.handleOnChange(event), onInput: (event) => this.handleOnInput(event), type: "range", value: this.value })));
  }
};
ModusSlider.style = modusSliderCss;

exports.modus_slider = ModusSlider;
